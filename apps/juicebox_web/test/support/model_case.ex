defmodule JuiceboxWeb.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import JuiceboxWeb.ModelCase
      import JuiceboxWeb.Factory
    end
  end

  setup tags do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(JuiceboxWeb.Repo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(JuiceboxWeb.Repo, {:shared, self()})
    end
